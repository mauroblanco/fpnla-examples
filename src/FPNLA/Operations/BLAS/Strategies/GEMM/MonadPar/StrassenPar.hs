...
module FPNLA.Operations.BLAS.Strategies.GEMM.MonadPar.StrassenPar () where
...
import           FPNLA.Operations.BLAS.Strategies.DataTypes (StrassenPar_MP,
                                                             getStrassenLimit)
...
instance (NFData (m e), Elt e, GEMM s m v e) => GEMM (StrassenPar_MP s) m v e where
    gemm (ctx, sctx) pmA pmB alpha beta mC =
        ...
        where
            ...
            toM ((a11, a12, a21, a22), (b11, b12, b21, b22), (c11, c12, c21, c22)) =
                (\[a, b, c, d, e, f, g] -> (a, b, c, d, e, f, g)) . runPar . MP.parMap id $
            ...
            toC (m1, m2, m3, m4, m5, m6, m7) =
                (\[a, b, c, d] -> (a, b, c, d)) . runPar . MP.parMap id $
